<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Banner.ascx.cs" Inherits="iLabs.ServiceBroker.iLabSB.Controls.Banner" %>
<table id="banner" cols="2" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="logo">
            <a href="http://www.uq.edu.au/" target="_blank">
                <asp:Image ID="imgLogo" runat="server" ImageUrl="../images/uq-logo2.gif" ImageAlign="Left"
